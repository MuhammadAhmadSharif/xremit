...
<table>
  ...
  <tr>
    ...
    <td>{{ getAmount($identifier_data->data->fees, 2) }} {{ $identifier_data->data->sender_currency }}</td>
  ...
  <tr>
    ...
    <td>{{ getAmount($identifier_data->data->receive_money, 2) }} {{ $identifier_data->data->receiver_currency }}</td>
...
<table>
  ...
  <tr>
    ...
    <td>{{  $identifier_data->data->currency->name }}</td>
  </tr>
  <tr>
    
    <td>Total Payable Amount</td>
    <td>{{ getAmount($identifier_data->data->payable_amount, 2) }} {{ $identifier_data->data->sender_currency }}</td>
  </tr>
</table>
